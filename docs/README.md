...
#### 留学サイトの改修およびバージョンアップ (2022/02〜2022/12)
- プロジェクト規模：
  - 改修は私 1 人で対応。インフラ周りやソースレビューは他エンジニアが対応
- 使用した技術：
  - PHP 5.5.50〜8.1
  - MySQL 5.7
  - Laravel 5〜9
...
- プロジェクト詳細：
  ...
  - 脆弱性診断を受けミドルウェアのアップデートと問題のある処理の修正をすることになった。ついでに機能追加も対応することになった
  - Laravel のバージョンを 5 から 6、さらに 6 から 9 へとアップデートした。Laravel のドキュメントのアップグレードガイドを確認したり larastan で構文エラーを解消したりした
  - バージョンアップに伴いエラーが発生した処理の修正
  - ユーザーのパスワードが管理画面から閲覧できる状態にあったのでハッシュ化してさらにパスワードの項目を除去した
  - 管理画面に管理ユーザーを管理する機能を追加実装
- 気づき・苦労したこと：
